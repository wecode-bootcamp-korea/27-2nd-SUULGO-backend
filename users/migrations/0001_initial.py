    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('alcohol_preference', models.IntegerField()),
                ('sparkling_preference', models.IntegerField()),
        ...
        migrations.CreateModel(
            name='UserAlcoholLever',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('alcohol_level', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='users.alcohollevel')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='users.user')),
            ],
            options={
